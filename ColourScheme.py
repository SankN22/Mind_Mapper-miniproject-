...
class ColourScheme:
    ...
    def __init__(self, cs_name=2):
        ...
        if cs_name == 1:
            ...
            # (0.258824, 0.521569, 0.956863) #tuple([i/255.0 for i in [19, 183, 242]])
            self.blue = (0, 0.47, 0.8)
            # tuple([i/255.0 for i in [217, 92, 81]])
            self.red = tuple([i/255.0 for i in [226, 60, 29]])
            # tuple([i/255.0 for i in [245, 185, 76]])
            self.orange = (1, 0.6, 0.27)
            ...
            self.highlight = tuple(
                [i*0.5 + 0.5 for i in self.blue])  # self.blue
            ...
            self.smallCircle = self.highlight2
            ...
            self.highlight2 = tuple(
                [i*0.75 + 0.25*v for i, v in zip(self.red, self.background)])
            ...
            # tuple([i*0.2 + 0.8*v for i, v in zip(self.blue_grey, self.background)])
            self.def_thought = self.background
        elif cs_name == 6:
            '''
